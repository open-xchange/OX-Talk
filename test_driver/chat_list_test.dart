...
void main() {
  group('Create chat list integration tests.', () {
    ...
    test('Test Create chat list integration tests.', () async {
      ...
      await createNewChat(setup.driver, createChatFinder, realEmail, meContact, newContact, name, enterContactName, emptyChat);
      //  Create second contact.
      await createNewChat(setup.driver, createChatFinder, newTestContact02, newTestName02, newContact, name, enterContactName, emptyChat);
      //  create third contact
      await createNewChat(setup.driver, createChatFinder, newTestContact01, newTestName01, newContact, name, enterContactName, emptyChat);
      ...
      //  Search contact.
      await chatSearch(setup.driver, newTestName01, searchString, find.byValueKey(keyChatListSearchIconButton), keySearchReturnIconButton);
    });
  });
}
