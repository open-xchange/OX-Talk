...
void main() {
  group('Test group chat functionality.', () {
    ...
    test('Test group chat functionality.', () async {
      ...
      await addNewContact(setup.driver, personAddFinder, keyContactChangeNameFinder, newTestName01, keyContactChangeEmailFinder, newTestContact01,
          keyContactChangeCheckFinder);
      await addNewContact(setup.driver, personAddFinder, keyContactChangeNameFinder, newTestName02, keyContactChangeEmailFinder, newTestContact02,
          keyContactChangeCheckFinder);
      await addNewContact(setup.driver, personAddFinder, keyContactChangeNameFinder, newMe, keyContactChangeEmailFinder, newTestContact04,
          keyContactChangeCheckFinder);
      ...
      await setup.driver.tap(pageBack);
      await chatTest(setup.driver, newNameTestGroup, typeSomethingComposePlaceholderFinder, helloWorld);
      await setup.driver.tap(pageBack);
