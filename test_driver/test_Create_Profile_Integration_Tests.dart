...
void main() {
  group('Ox coi test', () {
    ...
    final testUserNameUserProfil = 'EDN tester';
    final realEmail = 'enyakam3@ox.com';
    final realPassword = 'secret';
    final profilUserStatus =
        'Sent with OX Coi - https://github.com/open-xchange/ox-coi';
    ...
    final finderRootIconProfileTextTitle =
    find.byValueKey(keyRootIconProfileTitleText);
    ...
    final finderUserProfileUserNameText =
    find.byValueKey(testUserNameUserProfil);
    final finderUserProfileEmailText = find.byValueKey(realEmail);
    final finderUserProfileStatusText = find.byValueKey(profilUserStatus);
    ...
    test('Test create profile integration tests', () async {
      ...
      await driver.enterText(testUserNameUserProfil);
