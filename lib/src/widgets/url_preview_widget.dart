...
//
//class UrlPreviewWidget extends FutureBuilder<Url> {
//  final String messageText;
//
//  const UrlPreviewWidget({Key key, @required this.messageText}) : super(key: key);
//
//  @override
...
//    return InkWell(
//      onTap: _launch(url: snapshot.data.previewMetaData.url),
//      enableFeedback: true,
//      child: Column(
//        children: [
//          Container(
